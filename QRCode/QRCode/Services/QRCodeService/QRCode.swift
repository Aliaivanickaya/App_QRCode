...
//  QRCode
//
//  Created by Алиса Иваницкая on 09.05.2023.
//
...
// MARK: - Initializers
    ...
    public init(data: Data,
        ...
        self.init(imageGenerator: DefaultQRCodeImageGenerator(),
                  data: QRCode.prefix.data(using: .isoLatin1)! + data, color: color, backgroundColor: backgroundColor,
